...
export default function Learn() {
  return (
    <SectionWrapper id="learn" variant="learn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {topics.map(({ icon: Icon, title, desc }, i) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="group relative overflow-hidden rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-xl shadow-[0_30px_120px_-30px_rgba(0,0,0,0.6)]"
