...
export default function Curriculum() {
  return (
    <SectionWrapper id="curriculum" variant="curriculum">
        ...
        <div className="flex min-w-max gap-6">
          {weeks.map(({ icon: Icon, title, desc }, i) => (
            <motion.div
              ...
              className="relative h-56 w-[320px] shrink-0 rounded-3xl border border-white/15 bg-white/5 p-6 backdrop-blur-xl shadow-[0_30px_120px_-30px_rgba(0,0,0,0.6)]"
            >
